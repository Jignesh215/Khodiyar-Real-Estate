...
<td width="150" align="center" bgcolor="#999999"><font color="white"><strong>Property Booking</strong></td>
...
while($rows=mysqli_fetch_array($result))
{
	...
	$sqlp="SELECT * FROM property WHERE id_property='".$rows['id_property']."'";
$rowp=mysqli_query($conn,$sqlp);
$prop = mysqli_fetch_array($rowp);
...
<td bgcolor="#E2E2E2"><font color="black"><?php echo $prop['name_property'];?></td>
